 ...
 * </p>
 * <ul>
 *   <li>{@link com.shark.lang.dd.impl.OrExpressionImpl#getLeft <em>Left</em>}</li>
 ...
 * @generated
 */
public class OrExpressionImpl extends SharkExpressionImpl implements OrExpression
{
  /**
  ...
  /**
   * The cached value of the '{@link #getOrElts() <em>Or Elts</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getOrElts()
   * @generated
  ...
  {
    return DdPackage.Literals.OR_EXPRESSION;
  }
  ...
  public NotificationChain basicSetLeft(SharkExpression newLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdPackage.OR_EXPRESSION__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(SharkExpression newLeft)
  {
    if (newLeft != left)
    {
      ...
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdPackage.OR_EXPRESSION__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdPackage.OR_EXPRESSION__LEFT, null, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DdPackage.OR_EXPRESSION__LEFT, newLeft, newLeft));
  }
  ...
  public void setOp(String newOp)
  {
    ...
    op = newOp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DdPackage.OR_EXPRESSION__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetRight(SharkExpression newRight, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdPackage.OR_EXPRESSION__RIGHT, oldRight, newRight);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRight(SharkExpression newRight)
  {
    if (newRight != right)
    {
      NotificationChain msgs = null;
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdPackage.OR_EXPRESSION__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdPackage.OR_EXPRESSION__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DdPackage.OR_EXPRESSION__RIGHT, newRight, newRight));
  }
   ...
   */
  @Override
  public EList<OrExpressionElt> getOrElts()
  {
    if (orElts == null)
    {
      orElts = new EObjectContainmentEList<OrExpressionElt>(OrExpressionElt.class, this, DdPackage.OR_EXPRESSION__OR_ELTS);
    }
    return orElts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DdPackage.OR_EXPRESSION__LEFT:
        return basicSetLeft(null, msgs);
      case DdPackage.OR_EXPRESSION__RIGHT:
        return basicSetRight(null, msgs);
      case DdPackage.OR_EXPRESSION__OR_ELTS:
        return ((InternalEList<?>)getOrElts()).basicRemove(otherEnd, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DdPackage.OR_EXPRESSION__LEFT:
        return getLeft();
      case DdPackage.OR_EXPRESSION__OP:
        return getOp();
      case DdPackage.OR_EXPRESSION__RIGHT:
        return getRight();
      case DdPackage.OR_EXPRESSION__OR_ELTS:
